...
public class MainSettingsScreen extends Screen {
    ...
    public void render(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        ctx.drawText(this.textRenderer, "Cooldown Timer:",      labelX, startY + 7 * rowHeight + 5, 0xFFFFFFFF, true);
        ...
        ctx.drawText(this.textRenderer, "Distance HUD:", compactLeft + (compactButtonWidth + compactGap) * 3, compactLabelY, 0xFFFFFFFF, true);
    }
