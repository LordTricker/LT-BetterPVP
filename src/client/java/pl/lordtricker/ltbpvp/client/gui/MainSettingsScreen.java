...
public class MainSettingsScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawText(this.textRenderer, "Attack delay tutor:", labelX, startY + 0 * rowHeight + 5, 0xFFFFFF, false);
        context.drawText(this.textRenderer, "Sword Animation:",     labelX, startY + 1 * rowHeight + 5, 0xFFFFFF, false);
        ...
        context.drawText(this.textRenderer, "Armor status:",        labelX, startY + 4 * rowHeight + 5, 0xFFFFFF, false);
        context.drawText(this.textRenderer, "Auto Jump:",           labelX, startY + 5 * rowHeight + 5, 0xFFFFFF, false);
        context.drawText(this.textRenderer, "View Bobbing:",        labelX, startY + 6 * rowHeight + 5, 0xFFFFFF, false);
        context.drawText(this.textRenderer, "Screen Shake:",        labelX, startY + 7 * rowHeight + 5, 0xFFFFFF, false);
    }
