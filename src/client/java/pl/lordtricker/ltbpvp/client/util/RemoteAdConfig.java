...
public final class RemoteAdConfig {
    private static final String CONFIG_URL = "https://raw.githubusercontent.com/LordTricker/LT-BetterPVP/refs/heads/ad/config.json";
    private static final String DEFAULT_NAME = "LT-BetterPVP";
    ...
    public static void preloadAsync() {
        ...
        Thread t = new Thread(RemoteAdConfig::fetchOnce, "ltbpvp-remote-ad-fetch");
        t.setDaemon(true);
        t.start();
    }
    ...
    private static void fetchOnce() {
        try {
            ...
            HttpRequest req = HttpRequest.newBuilder()
                    ...
                    .header("User-Agent", "LT-BetterPVP/1 JavaHttpClient")
            ...
            if (resp.statusCode() >= 200 && resp.statusCode() < 300) {
                ...
                if (obj != null) {
                    ...
                    fetched = true;
                    System.out.println("[LT-BetterPVP] Remote config loaded: name='" + cachedName + "', address='" + cachedAddress + "'");
                }
            } else {
                System.out.println("[LT-BetterPVP] Remote config HTTP status: " + resp.statusCode());
            }
        } catch (Throwable t) {
            System.out.println("[LT-BetterPVP] Remote config fetch failed: " + t.getMessage());
        }
    }
